...
class all_student : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView=findViewById<RecyclerView>(R.id.rv_display)

        recyclerView.layoutManager= LinearLayoutManager(this@all_student)
        ...
        val result= retrofit.get_all_data()
        ...
        result.enqueue(object: Callback<List<studentdataitem>?>
        {
            override fun onResponse(
                ...
                val responseBody = response.body() as List<studentdataitem>

                val mystudentadapter= MyAdapter(this@all_student,responseBody)

...
import com.example.e_qiuz.MyModel
import com.example.e_qiuz.R
...
internal class MyAdapter(
    ...
    private val courseList: List<MyModel>,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater!!.inflate(R.layout.my_row_layout, null)
        }
        // on below line we are initializing our course image view
        // and course text view with their ids.
        courseIV = convertView!!.findViewById(R.id.imageview)
        courseTV = convertView!!.findViewById(R.id.textview)
